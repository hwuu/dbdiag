...
│                                                                           │
│  ┌─────────────────────────────────────────────────────────────────────┐  │
│  │                   Initial Round (start_conversation)                │  │
│  ├─────────────────────────────────────────────────────────────────────┤  │
│  │                                                                     │  │
│  │  User Problem: "Query slowed down, from seconds to half minute"     │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [1] Semantic Search Similar Tickets                                │  │
│  │      │   - search_by_ticket_description(user_problem)               │  │
│  │      │   - Return Top-5 similar tickets                             │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [2] Extract Candidate Phenomena                                    │  │
│  │      │   - get_phenomena_by_ticket_ids()                            │  │
│  │      │   - Store in session.hybrid_candidate_phenomenon_ids         │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [3] GAR Standard Flow                                              │  │
│  │      └─> HypothesisTracker → Recommender → Output                   │  │
│  │                                                                     │  │
│  └─────────────────────────────────────────────────────────────────────┘  │
│                                   │                                       │
│                                   ▼                                       │
│  ┌─────────────────────────────────────────────────────────────────────┐  │
│  │                  Middle Rounds (continue_conversation)              │  │
│  ├─────────────────────────────────────────────────────────────────────┤  │
│  │                                                                     │  │
│  │  User Feedback: "IO normal, index grew 6x, found slow queries"      │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [1] Detect Feedback Format                                         │  │
│  │      │   - Simple format ("1confirm 2deny") → Fast path             │  │
│  │      │   - Natural language → LLM structured extraction             │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [2] LLM Structured Extraction (non-simple format)                  │  │
│  │      │   Output: {                                                  │  │
│  │      │     "feedback": {"P-0001": "denied", "P-0002": "confirmed"}, │  │
│  │      │     "new_observations": ["found slow queries"]               │  │
│  │      │   }                                                          │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [3] Process Confirm/Deny                                           │  │
│  │      │   - Update session.confirmed_phenomena                       │  │
│  │      │   - Update session.denied_phenomena                          │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [4] Dynamic Retrieval (if new_observations exist)                  │  │
│  │      │   - query = new_observations.join(" ")                       │  │
│  │      │   - search_by_ticket_description(query)                      │  │
│  │      │   - Merge candidates to hybrid_candidate_phenomenon_ids      │  │
│  │      │                                                              │  │
│  │      ▼                                                              │  │
│  │  [5] GAR Standard Flow                                              │  │
│  │      └─> HypothesisTracker → Recommender → Output                   │  │
